  ...
  <div class="google-trans">
    <div class="left-panel" translate="no">
      ...
      <div class="panel-header">
        <h3>原文</h3>
        <el-button @click="exportText('original')" type="primary" size="small"
          >导出原文</el-button
        >
      </div>
      <div class="content">
    ...
    <div class="right-panel" translate="yes">
      ...
      <div class="panel-header">
        <h3>翻译</h3>
        <el-button @click="exportText('translated')" type="success" size="small"
          >导出翻译</el-button
        >
      </div>
      <div class="content">
...
const exportText = (type: "original" | "translated") => {
  // 获取对应面板的文本内容
  const panel =
    type === "original" ? ".left-panel .content" : ".right-panel .content";
  ...
  // 显示成功消息
  Msg({
    message: `已成功导出${type === "original" ? "原文" : "翻译"}文件`,
    type: "success"
  });
};
...
const exportAllText = () => {
  ...
  const originalText =
    originalElement.textContent || originalElement.innerText || "";
  const translatedText =
    translatedElement.textContent || translatedElement.innerText || "";
