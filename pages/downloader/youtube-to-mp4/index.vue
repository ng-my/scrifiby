<template>
  <div class="min-h-screen bg-[#fff]">
    ...
    <!-- 主体内容 -->
    <main class="part-bg">
      <div class="mx-auto max-w-[88.75rem] pb-[3.5rem] pt-[5.75rem]">
        <!--1、 标题和输入框 px-[8.75rem] -->
        <part1
    ...
    <main class="mx-auto max-w-[88.75rem] py-[3.5rem]">
      <!--3、 介绍说明  px-[5.5rem]-->
      <part3></part3>
    </main>
    <main class="part-bg">
      <div class="mx-auto max-w-[88.75rem] py-[3.5rem]">
        <!--4、 五大优势 -->
        <part4></part4>
        <!--5、 下载器特色 -->
        <part5></part5>
    ...
    <main class="mx-auto max-w-[88.75rem] pb-[9.5rem] pt-[3.5rem]">
      <!--7、 FAQ -->
      <part7></part7>
    </main>
  </div>
...
/* 可补充自定义样式 */
.part-bg {
  background-color: #f7faff; // #F7FAFF
}
